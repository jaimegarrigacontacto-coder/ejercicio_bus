...
while opcion != 0:
    ...
    if opcion == 1:
        billetes_comprar = int(input("Seleciona el numero de billetes que quieres comprar: "))
        buses[bus_seleccionado].ventaBilletes(billetes_comprar)
    elif opcion == 2:
        billetes_devolver = int(input("Seleciona el numero de billetes que quieres devolver: "))
